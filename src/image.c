 ...
 */
static int jpeg_dimensions(const unsigned char* d, size_t sz, int* w, int* h) {
 ...
 */
static int decode_png(const unsigned char* d, size_t sz, unsigned char** pixels, int* width,
    ...
    *height = (int)read_be32(d + 20);
    ...
    switch (color_type) {
        ...
        case 3:
            *channels = 3;
            break; /* indexed – treat as RGB after decoding */
        case 4:
            *channels = 2;
        ...
        for (int x = 0; x < bpp * (*width); x++) {
            ...
            switch (filt) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    recon[x] = a + (unsigned char)(((int)left + (int)up) / 2);
                    break;
                case 4:
                    recon[x] = a + paeth(left, up, upleft);
                    break;
                default:
                    recon[x] = a;
                    break;
