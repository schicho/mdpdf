...
static const PaperSize known_papers[] = {
    { 595.276f,  841.890f, "A4"     },
    { 612.0f,    792.0f,   "Letter" },
    { 612.0f,   1008.0f,   "Legal"  },
    { 841.890f, 1190.551f, "A3"     },
    { 419.528f,  595.276f, "A5"     },
    { 0, 0, NULL }
};
...
PaperSize paper_from_name(const char *name)
{
    for (int i = 0; known_papers[i].name; i++) {
        if (strcasecmp(known_papers[i].name, name) == 0)
            return known_papers[i];
    }
